...
由于独立分包中无法定义 `App`，小程序生命周期的监听可以使用 [`wx.onAppShow`](https://developers.weixin.qq.com/miniprogram/dev/api/wx.onAppShow.html)，[`wx.onAppHide`](https://developers.weixin.qq.com/miniprogram/dev/api/wx.onAppHide.html) 完成。`App` 上的其他事件可以使用 [`wx.onError`](https://developers.weixin.qq.com/miniprogram/dev/api/wx.onError.html)，[`wx.onPageNotFound`](https://developers.weixin.qq.com/miniprogram/dev/api/wx.onPageNotFound.html) 监听。
